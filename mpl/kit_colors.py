...
def gray(intensity: float) -> tuple:
    ...
    ----------
    intensity: float
        gray intensity  with range from 0 (white) to 1 (full color)
...
def hex_to_faded(hex_color: str, intensity: float = 1.) -> tuple:
    ...
    hex_color: str
        hex code of color
    intensity: float
        color intensity  with range from 0 (white) to 1 (full color)
    ...
    # Calculate faded RGB tuple
    faded_rgb = tuple(((1-intensity) + intensity * c/255) for c in rgb_color)

    # Return faded RGB tuple as argument tuple
    return faded_rgb + (1,)


cycle_black_grey = [gray90, gray80, gray75, gray70, gray60, gray50, gray40,
                    gray30, gray25, gray20, gray15, gray10, gray5,
                    gray90, gray80, gray75, gray70, gray60, gray50, gray40,
                    gray30, gray25, gray20, gray15, gray10, gray5,
                    gray90, gray80, gray75, gray70, gray60, gray50, gray40,
                    gray30, gray25, gray20, gray15, gray10, gray5]

cycle_color_main = [black, green, blue, red, yellow, orange, lightgreen, purple, brown, cyan,
                    gray80, green80, red80, blue80, yellow80, orange80, lightgreen80, purple80, brown80, cyan80]

cycle_linestyle_main = ['solid', 'dotted', 'dashed', 'dashdot']
